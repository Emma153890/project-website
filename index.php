<?php
    ...
    $stmt=$mysqli->prepare("SELECT email,password,id FROM userregistration WHERE email=? and password=? ");
        ...
        $getReg = $mysqli->prepare("SELECT regNo, firstName, lastName FROM userregistration WHERE id=?");
        $getReg->bind_param("i",$id);
        $getReg->execute();

        $res = $getReg->get_result();
        $row = $res->fetch_assoc();
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/hostel-img.jpg); background-size: 100% 100%" >
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center mt-3">
                                    <p>Don't have an account?
                                        <a href="./student/register-student.php" style="color:#e74c3c; font-weight-bold;">Register Here</a>
                                    </p>
                                </div>
