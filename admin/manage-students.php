<?php
    ...
    if(isset($_GET['del'])) {
        ...
        // Get room numner before deleting registration
        $query = "SELECT roomno FROM registration WHERE id=?";
        ...
        if($row = $result->fetch_assoc()){
            ...
            //Reduce occupied seats

            $update = "UPDATE rooms SET occupied_beds = occupied_beds - 1 WHERE room_no=? AND occupied_beds > 0";
