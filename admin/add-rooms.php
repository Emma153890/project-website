<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($row_cnt>0){
            ...
            $occupied = 0;
            $query="INSERT into  rooms (beds,room_no,fees, occupied_beds) values(?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('iiii',$beds,$roomno,$fees,$occupied);
            $stmt->execute();
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">No. of Bed(s)</h4>
                                        <div class="form-group mb-4">
                                            <select class="custom-select mr-sm-2" id="beds" name="beds" required="required">
