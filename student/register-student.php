<?php
    ...
    $query="INSERT into userregistration(regNo,surName,firstName,lastName,gender,contactNo,email,password) values(?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('ssssssss',$regno,$sname,$fname,$lname,$gender,$contactno,$emailid,$password);
    $stmt->execute();
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Surname</h4>
                                        <div class="form-group">
                                            <input type="text" name="sname" id="sname" placeholder="Enter Surname" required class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Contact Number</h4>
                                        <div class="form-group">
                                            <input type="text" name="contact" id="contact" placeholder="Your Contact" required="required" class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            <p>Already have an account?
                                <a href="../index.php" style="color: #e74c3c; font-weight:bold">
                                    Login Here
                                </a>
                            </p>
                        </div>
